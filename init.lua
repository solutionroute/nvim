...
if vim.fn.has "nvim-0.8" ~= 1 or vim.version().prerelease then
    ...
    require('core')
    -- lua/user.lua is not part of this repo and can be used as a per-user override should
    -- anyone else be using my configuration and need to customize their own keymaps or vim.opts.
    -- copy lua/user-example.lua to lua/user.lua and customize as needed.
